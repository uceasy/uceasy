import click
from uceasy.controller import phyluce_facade
...
def ctl(input, output, sheet, adapter_i7, adapter_i5, fastq_encoding, min_len, r1_pattern, r2_pattern, no_merge, single_end):
    try:
        click.echo(
            f'''
        ...
        phyluce_facade.run_quality_control(input, sheet, adapter_i7, adapter_i5)
        click.echo(f'Preprando para executar Trinity...')
        phyluce_facade.run_assembly()
